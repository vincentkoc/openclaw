		...
		params.provider === "brave"
			...
			: params.provider === "perplexity"
				...
				: params.provider === "grok"
					...
					: `${params.provider}:${params.query}:${params.count}:${params.tavilyBaseUrl ?? DEFAULT_TAVILY_BASE_URL}`,
	);
	...
	const description =
		provider === "perplexity"
			...
			: provider === "grok"
				...
				: provider === "tavily"
					? "Search the web using Tavily Search. Returns structured web results and may include a synthesized answer."
