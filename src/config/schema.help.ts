...
export const FIELD_HELP: Record<string, string> = {
	...
	"tools.web.search.grok.apiKey": "xAI API key (fallback: XAI_API_KEY env var).",
	"tools.web.search.grok.model": 'Grok model override (default: "grok-4-1-fast").',
	"tools.web.search.grok.inlineCitations":
		"Include inline citations in web_search responses for the Grok provider.",
	"tools.web.search.tavily.apiKey": "Tavily API key (fallback: TAVILY_API_KEY env var).",
	"tools.web.search.tavily.baseUrl": "Tavily base URL override (default: https://api.tavily.com).",
